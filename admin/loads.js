(function(){
  ...
  function showSection(section){
    const dash=$('dashboard'), cust=$('customers'), quotes=$('quotes'), loadsView=$('loads');
  ...
  function openLoad(id){
    ...
    $('load_status').value=l.status||'new'; $('load_source').value=l.source||'other'; $('loadModal').classList.remove('hidden');
  }
