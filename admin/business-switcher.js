(function(){
  ...
  function ensureDispatch(){loadScript('dispatch-v2.js?v=6','dispatchAdminScript');loadScript('dispatcher-access.js?v=4','dispatcherAccessScript');}
  ...
  function inject(){
    ...
    const style=document.createElement('style');style.id='businessSwitcherStyle';style.textContent=`#businessSwitcher{margin:0 14px 18px}#businessSwitcher .biz-switch-label{font-size:9px;letter-spacing:.16em;font-weight:800;color:#7890a6;margin:0 10px 8px}#businessSwitcher .biz-switch{display:grid;grid-template-columns:1fr 1fr;gap:5px;background:#071a2a;padding:4px;border:1px solid #17334a;border-radius:10px}#businessSwitcher .biz-switch button{border:0;background:transparent;color:#a9bdd0;border-radius:7px;padding:9px 6px;font:700 11px/1 inherit;cursor:pointer}#businessSwitcher .biz-switch button.active{background:#176fbe;color:#fff;box-shadow:0 4px 12px #176fbe33}#businessSwitcher .dispatch-subnav{margin:16px 2px 0;padding:0 7px 0 10px;border-left:1px solid #1d405b}#businessSwitcher .dispatch-subnav a{display:block!important;margin:2px 0;padding:8px 9px!important;border-radius:7px;color:#9eb4c8!important;font-size:11px!important;text-decoration:none}#businessSwitcher .dispatch-subnav a:hover{background:#0c263b!important;color:#fff!important}#businessSwitcher .dispatch-subnav a.active{background:#102f48!important;color:#fff!important}body.biz-dispatch-mode .portal-label{display:none}body.biz-dispatch-mode aside.sidebar nav{display:none!important}body.biz-dispatch-mode #dispatch{animation:bizDispatchIn .2s ease}body.biz-dispatch-mode[data-dispatch-view]:not([data-dispatch-view="overview"]) #dispatch .dv2-head,body.biz-dispatch-mode[data-dispatch-view]:not([data-dispatch-view="overview"]) #dispatch .dv2-kpis,body.biz-dispatch-mode[data-dispatch-view]:not([data-dispatch-view="overview"]) #dispatch .dv2-chartgrid{display:none!important}body.biz-dispatch-mode[data-dispatch-view="overview"] #dispatch .dv2-view{display:none!important}body.biz-dispatch-mode[data-dispatch-view="overview"] #dispatch .dv2-section{display:block!important}body.biz-dispatch-mode[data-dispatch-view="clients"] #dispatch .dv2-view[data-view="clients"],body.biz-dispatch-mode[data-dispatch-view="fleet"] #dispatch .dv2-view[data-view="fleet"],body.biz-dispatch-mode[data-dispatch-view="loads"] #dispatch .dv2-view[data-view="loads"],body.biz-dispatch-mode[data-dispatch-view="team"] #dispatch .dv2-view[data-view="team"],body.biz-dispatch-mode[data-dispatch-view="payments"] #dispatch .dv2-view[data-view="payments"]{display:block!important}body.biz-dispatch-mode[data-dispatch-view]:not([data-dispatch-view="overview"]) #dispatch .dv2-section,body.biz-dispatch-mode[data-dispatch-view]:not([data-dispatch-view="overview"]) #dispatch .dv2-view:not([data-view]){display:none!important}@keyframes bizDispatchIn{from{opacity:.2;transform:translateY(4px)}to{opacity:1;transform:none}}`;
  ...
  function switchBusiness(mode){
    ...
    if(mode==='dispatch')document.body.dataset.dispatchView='overview';else delete document.body.dataset.dispatchView;
