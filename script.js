...
// Might Logistics local 4K hero video.
...
if(heroBg){
  ...
  shade.style.cssText='position:absolute;inset:0;z-index:1;pointer-events:none;background:linear-gradient(90deg,rgba(6,16,29,.94) 0%,rgba(6,16,29,.82) 42%,rgba(6,16,29,.46) 72%,rgba(6,16,29,.2) 100%);';
